...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (!$this->app->runningInConsole() && application_installed()) {
            ...
            Gate::define('createcolleague.shopList', function ($user) {
                return $user->level == 'creator'; // Customize this condition as needed.
            });
            ...
            Gate::define('installmentreports.payRequestList', function ($user) {
                return $user->level == 'creator'; // Customize this condition as needed.
            });
            // installmentreports
            Gate::define('installmentreports', function ($user) {
            ...
            Gate::define('installmentreports.banklist', function ($user) {
                return $user->level == 'creator'; // Customize this condition as needed.
            });
            Gate::define('installmentreports.index', function ($user) {
                return $user->level == 'creator'; // Customize this condition as needed.
            });
            Gate::define('installmentreports.paidList', function ($user) {
                return $user->level == 'creator'; // Customize this condition as needed.
            });
        }
    }
