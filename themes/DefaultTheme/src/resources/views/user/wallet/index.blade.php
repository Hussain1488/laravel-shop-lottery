                        ...
                        <div class="table-responsive">
                            <table class="table table-order">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>{{ trans('front::messages.wallet.amount') }}
                                            ...
                                            <td class="text-center">
                                                @if ($history->status == 'success')
                                                    <div class="badge badge-pill badge-success badge-md">
                                                        {{ trans('front::messages.wallet.successful') }}</div>
                                                @else
                                                    <div class="badge badge-pill badge-danger badge-md">
                                                        {{ trans('front::messages.wallet.unsuccessful') }}</div>
                                                @endif
                                            </td>

                                            <td class="details-link">
                                                <a class="show-history"
                                                    data-action="{{ route('front.wallet.show', ['wallet' => $history]) }}"
